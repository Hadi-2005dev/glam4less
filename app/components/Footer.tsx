...
export function Footer() {
  return (
    <footer className="border-t border-border mt-10 px-4 md:px-6 lg:px-10 py-8">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center sm:flex-row sm:items-start sm:text-left sm:justify-center gap-10 sm:gap-20">
        <div className="flex flex-col items-center sm:items-start">
          ...
          <p className="text-sm text-muted-foreground max-w-xs">
            Feel Beautiful, Pay Less. Quality beauty essentials at prices that make sense.
          </p>
        </div>
      ...
      <p className="text-center text-xs text-muted-foreground mt-8">
        © {new Date().getFullYear()} Glam4Less. All rights reserved.
      </p>
    </footer>
  );
}
